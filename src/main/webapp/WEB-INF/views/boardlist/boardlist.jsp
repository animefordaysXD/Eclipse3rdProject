									...
									<td colspan="5">
										<ol class="paging">
											...
											<c:choose>
												...
												<c:otherwise>
													<li><a
														href="boardlist.do?cPage=${paging.beginBlock - paging.pagePerBlock}">이전으로</a></li>
												</c:otherwise>
											</c:choose>
											<!-- 블록안에 들어간 페이지번호들 -->
											<c:forEach begin="${paging.beginBlock}"
												...
												<c:choose>
													...
													<c:otherwise>
														<!-- 다른 페이지는 링크까지 -->
														<li><a href="boardlist.do?cPage=${k}">${k}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
											<!-- 다음 -->
											<c:choose>
												...
												<c:otherwise>
													<li><a
														href="boardlist.do?cPage=${paging.beginBlock + paging.pagePerBlock}">다음으로</a></li>
												</c:otherwise>
											</c:choose>
										</ol>
									</td>
