package com.ict.admin.boardlist.model.vo;

public class Boardlist_VO {
	private int post_idx, post_hit, u_idx, post_code, post_like, admin_idx, post_del;
	private String post_title, post_content, post_datetime, post_img, post_del_date;
	...
	public String getPost_del_date() {
		return post_del_date;
	}

	public void setPost_del_date(String post_del_date) {
		this.post_del_date = post_del_date;
	}
